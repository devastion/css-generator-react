...
export const TextShadow = () => {
  ...
  const [profiles, setProfiles]: any = useLocalStorage("text-shadow", {});
  ...
  return (
    <div className="p-4">
      ...
      <Preview styles={{ textShadow: `${offsetX}px ${offsetY}px ${blur}px ${color}` }} />
      <CopyCode code={`text-shadow: ${offsetX}px ${offsetY}px ${blur}px ${color}`} />
      <div className="mt-5">
